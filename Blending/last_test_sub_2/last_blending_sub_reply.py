...
def main():
    ...
    params = {
        'num_leaves': 161.33228961971352,
        'learning_rate': 0.01758139070765984,
        'max_depth': 70,
        'lambda_l1': 2.7350878811398975,
        'lambda_l2': 100.0,
        'colsample_bynode': 0.8721837398063907,
        'colsample_bytree': 0.4290994714669335,
        'bagging_fraction': 0.8,
        'bagging_freq': 1,
        'max_bin': 2467.6273369910364,
        'min_data_in_leaf': 2000.0,
    }
