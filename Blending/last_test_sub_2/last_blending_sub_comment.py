...
def main():
    ...
    params = {
        ...
        'max_depth': 8,
        'lambda_l1': 1000.0,
        'lambda_l2': 845.6970020186528,
        'colsample_bynode': 0.4639733899377055,
        'colsample_bytree': 0.5812801138350474,
        'bagging_fraction': 0.1,
        'bagging_freq': 5,
        'max_bin': 12.639189449586928,
        'min_data_in_leaf': 1133.3623541021082,
    }
