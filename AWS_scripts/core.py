...
class Booster(object):
    ...
    def __init__(self, params=None, cache=(), model_file=None):
        ...
        # Init custom eval
        self._custom_eval_every_x_round = 5
        self._custom_eval_current_best = np.inf
    ...
    def eval_set(self, evals, iteration=0, feval=None):
        ...
        if feval is not None:
            ...
            if self._custom_eval_mode == "every_x_round":
                if iteration % self._custom_eval_every_x_round == 0:
                    ...
                    res += '\t%s-%s:%f' % ("skipped", "skipped", 1000)
