...
class CreatorNumberOfEngagementGivenAbstract(GeneratedFeaturePickle, ABC):

    def __init__(self, dataset_id: str):

        super().__init__("creator_number_of_" + self._get_suffix() + "engagements_given", dataset_id)
        self.pck_path = pl.Path(
            f"{Feature.ROOT_PATH}/{self.dataset_id}/generated/creator_number_of_engagements_given/{self.feature_name}.pck.gz")
        self.csv_path = pl.Path(
            f"{Feature.ROOT_PATH}/{self.dataset_id}/generated/creator_number_of_engagements_given/{self.feature_name}.csv.gz")
...
class CreatorNumberOfEngagementGivenPositive(CreatorNumberOfEngagementGivenAbstract):
...
class CreatorNumberOfEngagementGivenNegative(CreatorNumberOfEngagementGivenAbstract):
...
class CreatorNumberOfEngagementGivenLike(CreatorNumberOfEngagementGivenAbstract):
...
class CreatorNumberOfEngagementGivenRetweet(CreatorNumberOfEngagementGivenAbstract):
...
class CreatorNumberOfEngagementGivenReply(CreatorNumberOfEngagementGivenAbstract):
...
class CreatorNumberOfEngagementGivenComment(CreatorNumberOfEngagementGivenAbstract):
