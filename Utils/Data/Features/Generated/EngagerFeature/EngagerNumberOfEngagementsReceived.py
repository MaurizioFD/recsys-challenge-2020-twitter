...
class EngagerNumberOfEngagementReceivedAbstract(GeneratedFeaturePickle, ABC):

    def __init__(self, dataset_id: str):

        super().__init__("engager_number_of_" + self._get_suffix() + "_engagements_given", dataset_id)
        self.pck_path = pl.Path(
            f"{Feature.ROOT_PATH}/{self.dataset_id}/generated/engager_number_of_engagements_given/{self.feature_name}.pck.gz")
        self.csv_path = pl.Path(
            f"{Feature.ROOT_PATH}/{self.dataset_id}/generated/engager_number_of_engagements_given/{self.feature_name}.csv.gz")
...
class EngagerNumberOfEngagementReceivedPositive(EngagerNumberOfEngagementReceivedAbstract):
...
class EngagerNumberOfEngagementReceivedNegative(EngagerNumberOfEngagementReceivedAbstract):
...
class EngagerNumberOfEngagementReceivedLike(EngagerNumberOfEngagementReceivedAbstract):
...
class EngagerNumberOfEngagementReceivedRetweet(EngagerNumberOfEngagementReceivedAbstract):
...
class EngagerNumberOfEngagementReceivedReply(EngagerNumberOfEngagementReceivedAbstract):
...
class EngagerNumberOfEngagementReceivedComment(EngagerNumberOfEngagementReceivedAbstract):
