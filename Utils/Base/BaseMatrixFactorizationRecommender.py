...
class BaseMatrixFactorizationClassicRecommender(BaseClassicRecommender):
    """
    ...
    def __init__(self, URM_train, verbose=True):
        super(BaseMatrixFactorizationClassicRecommender, self).__init__(URM_train, verbose=verbose)
