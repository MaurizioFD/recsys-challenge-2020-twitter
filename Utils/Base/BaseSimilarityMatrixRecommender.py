...
from Utils.Base.BaseClassicRecommender import BaseClassicRecommender
from Utils.Base.DataIO import DataIO
import numpy as np
from abc import ABC


class BaseSimilarityMatrixClassicRecommender(BaseClassicRecommender, ABC):
    """
    ...
    def __init__(self, URM_train, verbose=True):
        super(BaseSimilarityMatrixClassicRecommender, self).__init__(URM_train, verbose = verbose)
...
class BaseItemSimilarityMatrixRecommender(BaseSimilarityMatrixClassicRecommender):
...
class BaseUserSimilarityMatrixRecommender(BaseSimilarityMatrixClassicRecommender):
