...
LENGTH_PATH = BASE_PATH + "tweet_length/val_tweet_text_length_day_2.csv"
...
if __name__ == "__main__":
    ...
    tweet_ids_dict, current_mapping_tweet_ids = load_mapping(TWEET_IDS_MAPPING_PATH)
    ...
    mentions_file.write(TWEET_ID + ",mentions_count,mentions_tokens,mentions_text,mentions_mapped\n")
    hashtags_file.write(TWEET_ID + ",hashtags_count,hashtags_tokens,hashtags_text,hashtags_mapped\n")
    links_file.write(TWEET_ID + ",links_count,links_tokens,links_text,links_mapping\n")
